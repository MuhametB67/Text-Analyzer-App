...
def test_full_job_flow():
    ...
    # 3. Verify shape and key invariants
    ...
    # Sanity check each analysis has at least the fields the README promises
...
if __name__ == "__main__":
    # Allow running as a plain script: `python tests/test_smoke.py`
    try:
